...
const StoreCart = ({store}) =>{
    ...
    <div className="relative">
        ...
        {cartItemCount > 0 && <div className="absolute -top-1 -right-1 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center shadow-lg border-2 border-white">
            {cartItemCount}
        </div>}
    </div>
    )
